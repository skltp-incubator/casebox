...
@WebServiceClient(name = "ReceiveMedicalCertificateQuestionResponderService", 
                  wsdlLocation = "file:/C:/dev/NTJP/casebox/composites/casebox-schemas/src/main/resources/schemas/interactions/ReceiveMedicalCertificateQuestionInteraction/ReceiveMedicalCertificateQuestionInteraction_1.0_rivtabp20.wsdl",
...
public class ReceiveMedicalCertificateQuestionResponderService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/dev/NTJP/casebox/composites/casebox-schemas/src/main/resources/schemas/interactions/ReceiveMedicalCertificateQuestionInteraction/ReceiveMedicalCertificateQuestionInteraction_1.0_rivtabp20.wsdl");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from file:/C:/dev/NTJP/casebox/composites/casebox-schemas/src/main/resources/schemas/interactions/ReceiveMedicalCertificateQuestionInteraction/ReceiveMedicalCertificateQuestionInteraction_1.0_rivtabp20.wsdl");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
