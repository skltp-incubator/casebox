...
@XmlSeeAlso({org.w3.wsaddressing10.ObjectFactory.class, se.inera.ifv.receivemedicalcertificatequestionsponder.v1.ObjectFactory.class, se.inera.ifv.v2.ObjectFactory.class, se.inera.ifv.qa.v1.ObjectFactory.class, iso.v21090.dt.v1.ObjectFactory.class})
...
public interface ReceiveMedicalCertificateQuestionResponderInterface {
    ...
    public se.inera.ifv.receivemedicalcertificatequestionsponder.v1.ReceiveMedicalCertificateQuestionResponseType receiveMedicalCertificateQuestion(
        ...
        se.inera.ifv.receivemedicalcertificatequestionsponder.v1.ReceiveMedicalCertificateQuestionType parameters
    );
}
