...
@WebServiceClient(name = "FindAllQuestionsResponderService", 
                  wsdlLocation = "file:/C:/dev/NTJP/casebox/composites/casebox-schemas/src/main/resources/schemas/interactions/FindAllQuestionsInteraction/FindAllQuestionsInteraction_1.0_rivtabp20.wsdl",
...
public class FindAllQuestionsResponderService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/dev/NTJP/casebox/composites/casebox-schemas/src/main/resources/schemas/interactions/FindAllQuestionsInteraction/FindAllQuestionsInteraction_1.0_rivtabp20.wsdl");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from file:/C:/dev/NTJP/casebox/composites/casebox-schemas/src/main/resources/schemas/interactions/FindAllQuestionsInteraction/FindAllQuestionsInteraction_1.0_rivtabp20.wsdl");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
