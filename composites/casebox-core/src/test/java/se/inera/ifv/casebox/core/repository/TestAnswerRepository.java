...
@ContextConfiguration(
    locations = {"classpath:applicationContext.xml", "classpath:services-config.xml"})
public class TestAnswerRepository extends JpaRepositoryTestBase {
  ...
  public void removeAnswer() throws Exception {
    ...
    Collection<Answer> coll = answerRepository.findAll();
    ...
    ITable result =
        getConnection()
            .createQueryTable("ANSWER", "SELECT * FROM ANSWER WHERE CARE_UNIT = 'benny1'");
